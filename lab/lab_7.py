    ...
    def solve(self) -> None:
        ...
        with open(self.filepath, "w", encoding="utf-8-sig", newline="") as file:
            ...
            for movie in soup.find_all("div", class_="item_poster"):
                ...
                title = movie.find("a", {"data-tiara-layer": "moviename"}).get_text()
            ...
            for season in range(1, 9):  # For each season
                ...
                for episode in soup.find_all("div", class_="list_item"):
                    ...
                    review_count = episode.find(
                        "span", class_="ipl-rating-star__total-votes"
                    ).text.strip("()")
                    synopsis = episode.find("div", class_="item_description").text.strip()

                    writer.writerow([season, title, review_count, rating, synopsis])
